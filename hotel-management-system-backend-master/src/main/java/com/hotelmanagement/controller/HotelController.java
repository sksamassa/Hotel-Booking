...
public class HotelController {
	...
	public ResponseEntity<?> fetchHotel(@RequestParam int hotelId) {
	...
	public ResponseEntity<?> getProductsByCategories(@RequestParam int locationId) {
	...
	public void fetchProductImage(@PathVariable String hotelImageName, HttpServletResponse resp) {
