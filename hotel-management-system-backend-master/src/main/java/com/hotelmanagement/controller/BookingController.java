...
//			return new ResponseEntity(response, HttpStatus.BAD_REQUEST);
	...
	public ResponseEntity<?> fetchMyBooking(@RequestParam int userId) {
		LOG.info("Recieved request for fetch all booking");
	...
	public ResponseEntity<?> fetchBookingById(@RequestParam int bookingId) {
	...
	public ResponseEntity<?> fetchMyHotelBooking(@RequestParam int hotelId) {
		LOG.info("Recieved request for fetch all booking");
